<template>
  <div>
    <el-table :data="tableData" border v-loading="loading" element-loading-text="loading" style="width: 100%">
      <el-table-column prop="teacher_name" label="开课时间"></el-table-column>
      <el-table-column prop="provider_name" label="学生姓名"></el-table-column>
      <el-table-column prop="pay_method" label="学生出勤"></el-table-column>
      <el-table-column prop="actual_hours" label="上课老师"></el-table-column>
      <el-table-column prop="course_duration" label="原老师"></el-table-column>
      <el-table-column prop="percentOfTeacherUsed" label="渠道" v-if="!isProvider"></el-table-column>
      <el-table-column prop="bought_hours" label="临时代课"></el-table-column>
      <el-table-column prop="course_price" label="课程名称"></el-table-column>
      <el-table-column prop="pay_hours" label="单价"></el-table-column>
      <el-table-column prop="bought_money" label="金额"></el-table-column>
      <el-table-column prop="pay_money" label="备注"></el-table-column>
    </el-table>
