                ...
                <el-form >
                  ...
                  <el-form-item label="上传" style="margin-bottom:10px" class='jobRes'>
                    <div style="margin-left:68px">
                      <el-row>
                        <el-col :span="15">
                          <el-upload :limit="1" :ref="item.ref" class="upload-demo"
                                     :action="upload_url"
                                     :headers="myHeaders"
                                     :data="upLoadData"
                                     :on-preview="(file)=>{
                        ...
                        <el-col :span="21">
                          <el-input v-if="item.attachment_flag"  type="textarea"  :rows="7"  placeholder="请输入音频歌词"  v-model="item.attachment"></el-input>
                        </el-col>
...
export default {
  ...
  created() {
    ...
    getJobDetail(id).then((res) => {
      ...
      this.onOptionChange('stage',true);
    });
  ...
  methods: {
    ...
    onSubmit() {
      ...
      patchJobs(this.id, new_data).then((res) => {
    ...
    onOptionChange(option,begin=false){
      switch (option){
        case 'product_type':
          this.form.stage = '';
          this.form.course_id = '';
