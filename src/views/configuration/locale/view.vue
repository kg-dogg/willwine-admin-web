                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-2 col-lg-2 col-md-2">
                                <ul class="list-group">
                                    <li v-for="(mdl,index) in modules" :key="index" :class="[mdl === module ? 'active' : '', 'list-group-item']"><router-link :to="getModuleLink(mdl)" exact>{{getName(mdl)}}</router-link></li>
                                </ul>
                            </div>
                                ...
                                <div v-if="getWordCount">
                                    <div v-for="(word,index) in words" :key="index">
                                        <div v-if="typeof word === 'object'">
                                            <div class="form-group" v-for="(wrd,i) in word" :key="i">
...
export default {
  ...
  methods: {
    ...
    getName(param) {
      const name = helper.ucword(param);
  ...
  watch: {
    '$route.params.module': function (newModule, oldModule) {
