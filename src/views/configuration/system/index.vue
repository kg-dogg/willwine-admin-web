                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="configForm.color_theme" class="custom-select col-12">
                                                          <option v-for="(option,index) in systemConfigVariables.color_themes" :key='index' v-bind:value="option.value">
                                                            {{ option.text }}
                                                          </option>
                                                        </select>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="configForm.direction" class="custom-select col-12">
                                                          <option v-for="(option,index) in systemConfigVariables.directions" :key='index' v-bind:value="option.value">
                                                            {{ option.text }}
                                                          </option>
                                                        </select>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="configForm.date_format" class="custom-select col-12">
                                                          <option v-for="(option,index) in systemConfigVariables.date_formats" :key='index' v-bind:value="option.value">
                                                            {{ option.text }}
                                                          </option>
                                                        </select>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="configForm.time_format" class="custom-select col-12">
                                                          <option v-for="(option,index) in systemConfigVariables.time_formats" :key='index' v-bind:value="option.value">
                                                            {{ option.text }}
                                                          </option>
                                                        </select>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="configForm.notification_position" class="custom-select col-12">
                                                          <option v-for="(option,index) in systemConfigVariables.notification_positions"  :key='index' v-bind:value="option.value">
                                                            {{ option.text }}
                                                          </option>
                                                        </select>
                                                ...
                                                <div class="col-12 col-md-6" v-if="getConfig('multilingual')">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="configForm.locale" class="custom-select col-12">
                                                          <option v-for="(option,index) in systemConfigVariables.locales" :key='index' v-bind:value="option.value">
                                                            {{ option.text }}
                                                          </option>
                                                        </select>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="configForm.timezone" class="custom-select col-12">
                                                          <option v-for="(option,index) in systemConfigVariables.timezones" :key='index' v-bind:value="option.value">
                                                            {{ option.text }}
                                                          </option>
                                                        </select>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="configForm.page_length" class="custom-select col-12">
                                                          <option v-for="(option,index) in getConfig('pagination')" :key='index' v-bind:value="option">
...
export default {
  ...
  mounted() {
    ...
    axios.get('/configuration/variable?type=system')
      .then(response => response.data)
      .then((response) => {
    ...
    submit() {
      ...
      this.configForm.post('/configuration')
        .then((response) => {
          ...
          document.querySelector('#theme').attr('href', `/css/colors/${helper.getConfig('color_theme')}.css`);

          if (helper.getConfig('direction') !== this.direction || helper.getConfig('locale') !== this.locale) { location.reload(); }
